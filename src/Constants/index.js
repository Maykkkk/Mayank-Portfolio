...
export const AppText={
   hello:'Hello,',
   Iam:'I am ',
   MayankGupta:'Mayank Gupta',
   aboutMeDescripion:'I am Currently Pursuing My B-Tech from IIT BHU (Varanasi). Loved to Code and Contribute. Last 2 Years as Full stack developer. Expert in Front-end  and Back-end Development',
   Skills:'Skills & ',
   Experties:'Experties',
   ...
   Contact:'Contact ',
   Us:'Us',
   copywriteText:'Copyright by Mayank Gupta @2023'
